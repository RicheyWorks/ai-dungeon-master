 ...
 *
 * <ul>
 *   <li>{@code GET  /v2/marketplace} — list packs under content-packs dir</li>
 *   <li>{@code GET  /v2/marketplace/{id}} — pack detail</li>
 *   <li>{@code POST /v2/marketplace/{id}/install} — register pack into the live catalog</li>
 * </ul>
 */
@RestController
...
public class MarketplaceController {
    ...
    public ResponseEntity<Envelope<?>> install(
        ...
        Map<String, Object> payload = Map.of(
                ...
                "marketplace", marketplace.list(null));
